...
module.exports.run = async (client, message, args) => {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField("Check out", "[Invite](https://discord.com/api/oauth2/authorize?client_id=838184020469743636&permissions=8&scope=bot) invite Kurdish Giveaway in server / thank you")
      .setTimestamp()
      .setFooter(`Command Requested By ${message.author.tag}`, client.user.displayAvatarURL());
    message.channel.send("**Sent the commands in Direct Messages! <a:emoji_8:881643750017892352>, Check DMs**");
